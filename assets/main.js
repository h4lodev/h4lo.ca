(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('#text04', { style: 'wipe-right', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text05', { style: 'wipe-left', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#intro1', { style: 'wipe-left', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#intro2', { style: 'wipe-right', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
